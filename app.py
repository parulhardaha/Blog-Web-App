...
def seed_database():
    ...
    if not admin_user:
        ...
        another_user = Users(username="deepanshu", email="deepanshu@example.com", name="Deepanshu Hardaha")
